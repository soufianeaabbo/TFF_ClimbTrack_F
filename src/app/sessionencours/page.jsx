export default function SessionEnCours() {
    ...
    return (
        <div className="flex justify-center">
            ...
            <div className="flex flex-col items-center justify-center border w-200 gap-5 ">
                ...
                <div className="bg-blue-400  flex flex-col gap-5 w-full">
